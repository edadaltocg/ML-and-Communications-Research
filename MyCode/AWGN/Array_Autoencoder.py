...
NoiseL = tf.keras.Sequential([
        ...
        layers.Lambda(fn.BPSK,input_shape=(n,), output_shape=(n,), name='Round'),
...
linelist = ['--', '-', '-']
colorlist = ['k', 'k', 'grey']
fig = fn.plotAWGN([Eb_No_dB,Eb_No_dB, Eb_No_dB], [avgMAPError, 
             avgAAutoencoderError, theoreticalErrorBPSK], 
            ['Soft MAP Decoder', 'Array Autoencoder',  'Uncoded BPSK'],
